"""
train.py - Training loop for liver CT segmentation GAN.

Trains a Generator-Discriminator pair with mixed precision, validation,
best model checkpointing, and validation prediction saving.
...
Outputs:
    ...
    - checkpoints/val_predictions/        (visual predictions per epoch)
    - checkpoints/loss_curve.png          (training vs validation loss)
"""
...
MAX_VAL_SAMPLES = 100
LOG_INTERVAL = 50
VIS_INTERVAL = 1  # save predictions every N epochs
